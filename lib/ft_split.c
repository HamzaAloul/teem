...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/04 23:11:11 by halalul           #+#    #+#             */
/*   Updated: 2025/12/04 23:51:26 by halalul          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**allocate_words(char const *s, char c, char **array)
{
	int	i;
	int	j;
	int	w;
...
char	**ft_split(char const *s, char c)
{
	...
	if (!array)
		return (NULL);
	array = allocate_words(s, c, array);
	if (!array)
		return (NULL);
